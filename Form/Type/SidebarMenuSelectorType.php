 ...
 */
class SidebarMenuSelectorType extends AbstractType {
        ...
        foreach ($categories as $category) {
            if (is_array($category)) {
                foreach ($category as $each_category) {
                    ...
                    $choices[$each_category->getId()] = sprintf("%s - %s", $each_category->getName(), $each_category->getTitle());
                ...
                $choices[$category->getId()] = sprintf("%s - %s", $category->getName(), $category->getTitle());
    ...
    public function getName() {
        return 'map2u_core_sidebarmenu_selector';
    }
